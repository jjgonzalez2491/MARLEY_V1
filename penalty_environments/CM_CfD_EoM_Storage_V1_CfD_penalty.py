...
class CM_EoM(MultiAgentEnv):
	...
	def step(self, action_dict):
		...
		if self.CfD_auction_indicator and self.month == 5:
	...
	def get_action_masks_g(self, investments_enabled, capacity_existing_storage_lt):
		...
		for j in range(self.act_bids_CfD):
			...
			if self.month != 4 or self.CfD_auction_indicator == False or self.max_year - self.year - 5 <= self.construction_time[j] or investments_enabled[j] == 0:
