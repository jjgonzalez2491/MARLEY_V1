...
class CM_EoM(MultiAgentEnv):
	...
	def step(self, action_dict):
		...
		if self.cm_auction_indicator and self.month == 3:
	...
	def get_action_masks_g(self, investments_enabled, capacity_existing_storage_lt):
		...
		for j in range(self.act_bids_cm):
			...
			if self.month != 2 or self.cm_auction_indicator == False or self.cm_tech_cc[0,j] <= 0.02 or self.max_year - self.year - 5 <= construction_time or investments_enabled[j] == 0:
