...
# EoM - 8 agents
ax.plot(x_axis, emissions_mean[7,:], label=run_codes[7] , color = colors[0])
ax.fill_between(x_axis, emissions_percentile_25[7,:], emissions_percentile_75[7,:], color = colors[0], alpha = 0.2 )

ax.xaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.yaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
...
# EoM - 16 agents
ax.plot(x_axis, emissions_mean[1,:], label=run_codes[1] , color = colors[1])
ax.fill_between(x_axis, emissions_percentile_25[1,:], emissions_percentile_75[1,:], color = colors[1], alpha = 0.2 )
...
# EoM - 32 agents
ax.plot(x_axis, emissions_mean[4,:], label=run_codes[4] , color = colors[2])
ax.fill_between(x_axis, emissions_percentile_25[4,:], emissions_percentile_75[4,:], color = colors[2], alpha = 0.2 )
...
# CM - 8 agents
ax.plot(x_axis, emissions_mean[11,:], label=run_codes[11] , color = colors[3])
ax.fill_between(x_axis, emissions_percentile_25[11,:], emissions_percentile_75[11,:], color = colors[3], alpha = 0.2 )
...
ax = axes[1,1]
# CM - 16 agents
ax.plot(x_axis, emissions_mean[9,:], label=run_codes[9] , color = colors[4])
ax.fill_between(x_axis, emissions_percentile_25[9,:], emissions_percentile_75[9,:], color = colors[4], alpha = 0.2 )
...
# CM - 32 agentss
ax.plot(x_axis, emissions_mean[10,:], label=run_codes[10] , color = colors[5])
ax.fill_between(x_axis, emissions_percentile_25[10,:], emissions_percentile_75[10,:], color = colors[5], alpha = 0.2 )
ax.xaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.yaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.set_xlim(2020, x_limit)
ax.set_ylim(2,14)
...
# CfD - 8 agents
ax.plot(x_axis, emissions_mean[8,:], label=run_codes[8] , color = colors[6])
ax.fill_between(x_axis, emissions_percentile_25[8,:], emissions_percentile_75[8,:], color = colors[6], alpha = 0.2 )
ax.xaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.yaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
...
# CfD - 16 agents
ax = axes[1,2]
ax.plot(x_axis, emissions_mean[2,:], label=run_codes[2] , color = colors[7])
ax.fill_between(x_axis, emissions_percentile_25[2,:], emissions_percentile_75[2,:], color = colors[7], alpha = 0.2 )
ax.xaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.yaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
...
# CfD - 32 agents
ax = axes[2,2]
ax.plot(x_axis, emissions_mean[5,:], label=run_codes[5] , color = colors[8])
ax.fill_between(x_axis, emissions_percentile_25[5,:], emissions_percentile_75[5,:], color = colors[8], alpha = 0.2 )
ax.xaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.yaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
...
# CM + CfD - 8 agents
ax.plot(x_axis, emissions_mean[6,:], label=run_codes[6] , color = colors[9])
ax.fill_between(x_axis, emissions_percentile_25[6,:], emissions_percentile_75[6,:], color = colors[9], alpha = 0.2 )
ax.xaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.yaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
...
# CM + CfD - 16 agents
ax = axes[1,3]
ax.plot(x_axis, emissions_mean[0,:], label=run_codes[0] , color = colors[10])
ax.fill_between(x_axis, emissions_percentile_25[0,:], emissions_percentile_75[0,:], color = colors[10], alpha = 0.2 )
ax.xaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.yaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
...
# CM + CfD - 32 agents
ax = axes[2,3]
ax.plot(x_axis, emissions_mean[3,:], label=run_codes[3] , color = colors[11])
ax.fill_between(x_axis, emissions_percentile_25[3,:], emissions_percentile_75[3,:], color = colors[11], alpha = 0.2 )
ax.xaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
ax.yaxis.set_major_locator(plt.MaxNLocator(3))  # Reduce number of ticks
...
fig.supxlabel('Year')
fig.supylabel('CO2 emissions [MtonCO2eq - Bimester]')
plt.tight_layout()
plt.show()
plt.savefig("plot_metrics_final_agents_emissions_v2.pdf", format="pdf", bbox_inches="tight")
